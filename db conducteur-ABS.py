...
try:
    ...
    for conducteur in conducteurs:
        nom = conducteur['CHAUFFEUR']
        telephone = conducteur['N° TEL']
        print(telephone)
        numero_permis = '000000'  # Utilisation de get pour obtenir la valeur avec une gestion des clés inexistantes
        # Utilisation de get pour obtenir la valeur avec une gestion des clés inexistantes
        ...
        if not conducteur_existe(nom):
            ...
            for champ in ['telephone_conducteur', 'numero_permis', 'code_chauffeur']:
